...
以下是**实机验证过**的 Minecraft 版本（来自 `D:\software\mc\.minecraft\versions`）：

| Minecraft | 对应 Jar | 状态 |
|-----------|----------|------|
| 1.20.1 | `waypointmenu-1.0.0+1.20-1.20.1.jar` | ✅ 已验证 |
| 1.20.4 | `waypointmenu-1.0.0+1.20.2-1.20.4.jar` | ✅ 已验证 |
| 1.21 / 1.21.1 | `waypointmenu-1.0.0+1.21-1.21.1.jar` | ✅ 已验证 |
| 1.21.4 | `waypointmenu-1.0.0+1.21.2-1.21.4.jar` | ✅ 已验证 |
| 1.21.6 | `waypointmenu-1.0.0+1.21.6.jar` | ⚠️ 已修复，待实机验证 |
| 1.21.11 | `waypointmenu-1.0.0+1.21.11.jar` | ✅ 已验证 |

> 另有 `waypointmenu-1.0.0+1.20.5-1.20.6.jar`（覆盖 1.20.5~1.20.6），尚未实机验证。
>
> 完整的 `mc_compat` 覆盖范围：
>
> | Jar | 覆盖版本 |
...
> | `+1.21.2-1.21.4` | 1.21.2 ~ 1.21.4 |
> | `+1.21.6` | 1.21.6 |
> | `+1.21.11` | 1.21.11 |
>
> ⚠️ **1.21.5 与 1.21.7 ~ 1.21.10 暂无对应 Jar**：这些版本尚未加入构建（Yarn 映射均已存在），可后续逐个补充版本目标，而不是靠「拓宽某个 Jar」来覆盖。
